...
for i in range(1, 19):
    ...
    if a == 4 and cnt <=2 and hospital[i-1][0] != 4 and hospital[i-2][0] != 4 :
        cnt = cnt + 1
        hospital[i][0] = a
    else:
        hospital[i][0] = 3
    ...
    a = random.randint(3, 4)
    if a == 4 and cnt <= 2 and hospital[i-1][24] != 4 and hospital[i-2][24] != 4:
        cnt = cnt + 1
        hospital[i][24] = a
    else:
        hospital[i][24] = 3
...
for j in range(1, 23):
    a = random.randint(3, 4)
    if a == 4 and cnt <= 2 and hospital[19][j-1] != 4 and hospital[19][j-2] != 4 :
        cnt = cnt + 1
        hospital[19][j] = a
    else:
        hospital[19][j] = 3
    ...
    a = random.randint(3, 4)
    if a == 4 and cnt <= 2 and hospital[0][j-1] != 4 and hospital[0][j-2] != 4 :
        cnt = cnt + 1
        hospital[0][j] = a
    else:
        hospital[0][j] = 3
